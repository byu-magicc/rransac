...
class SourceSENPosVel: public SourceBase<tState,tMeasurementType, tTransformation<tState>, SourceSENPosVel<tState, tMeasurementType, tTransformation>> {
...
typedef SourceBase<tState,tMeasurementType, tTransformation<tState>, SourceSENPosVel<tState, tMeasurementType, tTransformation>> Base;                          /**< The source base class. */
...
template <typename tState, MeasurementTypes tMeasurementType, template <typename > typename tTransformation>
void SourceSENPosVel<tState,tMeasurementType,tTransformation>::DerivedInit(const SourceParameters& params) {


    if (has_vel_) {
        Base::H_ = Eigen::Matrix<DataType,meas_space_dim_+tState::Algebra::dim_t_vel_, cov_dim_>::Zero();
        Base::V_ = Eigen::Matrix<DataType,meas_space_dim_ + meas_space_dim_,meas_space_dim_+ tState::Algebra::dim_t_vel_>::Identity();
    } else {
        Base::H_ = Eigen::Matrix<DataType, meas_space_dim_, cov_dim_>::Zero();
