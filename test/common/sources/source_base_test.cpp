...
// Initialize source
SourceBase source;
source.Init<SourceTypes::R2_POS>(params);
...
// Test Jacobia.
ASSERT_EQ(H, source.GetLinObsMatState<SourceTypes::R2_POS>(state));
ASSERT_EQ(V, source.GetLinObsMatSensorNoise<SourceTypes::R2_POS>(state));
